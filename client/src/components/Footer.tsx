        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#services" className="hover:text-yellow-400 transition-colors duration-300">Groundworks & Site Preparation</a></li>
              <li><a href="#services" className="hover:text-yellow-400 transition-colors duration-300">Fencing, Sleepers & Screening</a></li>
              <li><a href="#services" className="hover:text-yellow-400 transition-colors duration-300">Patios, Paths & Paving</a></li>
              <li><a href="#services" className="hover:text-yellow-400 transition-colors duration-300">Artificial Grass & Garden Finishes</a></li>
              <li><a href="#services" className="hover:text-yellow-400 transition-colors duration-300">External Painting & Maintenance</a></li>
            </ul>
          </div>
