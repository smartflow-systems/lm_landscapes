      ...
      <div className="container mx-auto px-4 min-h-screen flex flex-col justify-center items-start py-16 sm:py-20 md:py-24 relative z-10 max-w-full">
        <div className="max-w-full sm:max-w-2xl w-full">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto">
            <a 
              href="#contact" 
              className="bg-primary hover:bg-accent text-white text-sm sm:text-base md:text-lg font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg inline-flex items-center justify-center whitespace-nowrap"
            >
            ...
            <a 
              href="#services" 
              className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-primary text-sm sm:text-base md:text-lg font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-full transition-all duration-300 inline-flex items-center justify-center whitespace-nowrap"
            >
